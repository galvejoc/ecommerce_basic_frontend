      ...
      <div className="flex overflow-x-auto space-x-2 py-1">
        {categories.map((cat) => (
          <button
            ...
            className={`px-3 uppercase py-1 rounded-xl border text-xs border-primary transition ${comboSingleFilters.categoryUuid === cat.uuid
      ...
      <div className="flex overflow-x-auto space-x-2 py-1">
        {tags.map((e) => (
          <button
            ...
            className={`px-3 uppercase py-1 rounded-xl border border-primary text-xs transition ${comboSingleFilters.tagUuid === e.uuid
              ? 'bg-primary text-white'
              : 'bg-background hover:bg-gray-200 text-secondary'
              }`}
          >
