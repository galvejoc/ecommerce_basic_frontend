...
export function FormLogin() {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6 bg-color-background">
      ...
      <button type="submit" className="w-full text-white bg-primary hover:bg-primary/90 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center duration-300 transition-colors cursor-pointer">
