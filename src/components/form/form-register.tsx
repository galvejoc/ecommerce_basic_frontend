...
export function FormRegister() {
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      <button type="submit" className="w-full text-white bg-primary hover:bg-primary/90 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">
